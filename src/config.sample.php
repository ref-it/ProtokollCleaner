...
define('OIDC_ACCESS_GROUP', ''); // Pflicht-Gruppe für generellen Zugriff (Login-Gate) - leer = jeder erfolgreich authentifizierte User
...
define('OIDC_AUTHGROUP', ''); // Pflicht-Gruppe, siehe OIDC_GROUPS_CLAIM - leer = jeder erfolgreich authentifizierte User
