...
class protocolOut
{
    ...
    protected static function generateDiffLegend()
    {
    	return "<h3>Protokollvorschau</h3>\n".
    		...
    		"<span>Legende</span>\n".
    		'<div><span class="color border border-dark"></span><span class="symbol">+</span><span class="desc">Automatisch ergänzte Zeilen - Werden in generiertes Protokoll übernommen</span></div>'."\n".
    ...
    protected static function generateDiffRemovedLine($line)
    {
        return "<div class='line removed'>\n".
        	'<span></span><span></span><span>'.htmlspecialchars($line)."</span>\n".
        "</div>\n";
    }
